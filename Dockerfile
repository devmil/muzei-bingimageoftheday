...
RUN apk add --update openssl \
	...
	&& unzip gradle-6.1.1-bin.zip -d /opt/ \
	&& mv opt/gradle-6.1.1/ opt/gradle \
...
RUN yes | sdkmanager --licenses \
	&& sdkmanager "platforms;android-28" "platform-tools" "extras;google;m2repository" "build-tools;28.0.3" --verbose
